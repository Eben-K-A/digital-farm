...
const navItems = [
  { icon: LayoutDashboard, label: "Overview", href: "/buyer" },
  { icon: ShoppingBag, label: "My Orders", href: "/buyer/orders" },
  { icon: MapPin, label: "Addresses", href: "/buyer/addresses" },
  { icon: Heart, label: "Favorites", href: "/buyer/favorites" },
  { icon: Star, label: "Reviews", href: "/buyer/reviews" },
          ...
          <div className="p-4 border-t border-border">
            <div className="flex items-center gap-3 px-4 py-3 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-foreground truncate">Akua Mensah</p>
                <p className="text-sm text-muted-foreground truncate">Buyer</p>
              </div>
            </div>
            <Link
              to="/auth"
