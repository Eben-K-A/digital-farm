...
const navItems = [
  ...
  { icon: ArrowUpDown, label: "Stock Movements", href: "/warehouse/movements" },
  { icon: Truck, label: "Farmer Drop-offs", href: "/warehouse/dropoffs" },
  { icon: FileText, label: "Reports", href: "/warehouse/reports" },
          ...
          <div className="p-4 border-t border-border">
            <div className="flex items-center gap-3 px-4 py-3 mb-2">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-medium text-foreground truncate">Emmanuel Tetteh</p>
                <p className="text-sm text-muted-foreground truncate">Warehouse Manager</p>
              </div>
            </div>
            <Link
              to="/auth"
